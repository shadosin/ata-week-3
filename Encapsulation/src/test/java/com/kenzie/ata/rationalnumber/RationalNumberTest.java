...
public class RationalNumberTest {
    ...
    private static String BASE_PACKAGE = "com.kenzie.ata";
    ...
    public void rationalNumberClass_containsCorrectConstructors() {
        Class<?> rationalNumberClass = assertDoesNotThrow( () -> ClassQuery.inContainingPackage(BASE_PACKAGE)
                .withExactSimpleName("RationalNumber")
                .findClassOrFail(), "The RationalNumber class must exist before this test will pass.");

        Constructor constructor1 = assertDoesNotThrow( () -> ConstructorQuery.inClass(rationalNumberClass)
                .withExactArgTypes(Arrays.asList())
                .findConstructor(), "The RationalNumber Class should have 1 parameterless constructor.");

        Constructor constructor2 = assertDoesNotThrow( () -> ConstructorQuery.inClass(rationalNumberClass)
        ...
        Constructor constructor3 = assertDoesNotThrow( () -> ConstructorQuery.inClass(rationalNumberClass)
    ...
    public void rationalNumberClass_containsUpdateMethod() {
        ...
        Method updateMethod = assertDoesNotThrow( () -> MethodQuery.inType(rationalNumberClass)
    ...
    public void rationalNumberClass_containsGetterMethods() {
        ...
        Method getDenominator = assertDoesNotThrow( () -> MethodQuery.inType(rationalNumberClass)
                .withExactName("getDenominator")
                .findMethodOrFail(), "The getter method for Denominator was not found in the RationalNumber Class");

        Method getNumerator = assertDoesNotThrow( () -> MethodQuery.inType(rationalNumberClass)
    ...
    public void rationalNumberClass_containsNoSetters() {
        ...
        try {
            ...
            assertNull(setNumeratorMethod, "The RationalNumber class should not contain any setters.");
        }
        ...
        try {
            ...
            assertNull(setDenominatorMethod, "The RationalNumber class should not contain any setters.");
        }
        catch(Exception exception) {
            assertTrue(true);
        }
