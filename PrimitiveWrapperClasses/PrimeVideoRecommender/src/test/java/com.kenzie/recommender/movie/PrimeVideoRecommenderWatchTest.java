package test.java.recommender.movie;
...
class PrimeVideoRecommenderWatchTest {
    ...
    public void watch_nonExistentPrimeVideo_throwIllegalArgumentsException() {
        ...
        // WHEN + THEN
        Assertions.assertThrows(IllegalArgumentException.class, () -> primeVideoRecommender.watch(nonExistentMovie));
    }
    ...
    public void watch_watchPrimeVideo_addToMostRecentlyViewed() {
        ...
        Assertions.assertTrue(false, "Not yet implemented.");
    }
}
