...
class MostRecentlyUsedTest {
    ...
    public void size_withoutAddingAnything_shouldHaveZeroSize() {
        ...
        // THEN
        Assertions.assertEquals(0, size, "Size should be 0.");
    }
    ...
    public void add_addMoreThanCapacity_returnsFirstElementAdded() {
        ...
        // THEN
        Assertions.assertEquals(elementsToAdd[0], removed, "First element added should have been the one removed.");
    }
